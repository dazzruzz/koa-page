	...
	return (
		...
		<div className='fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute'>
			...
			<div className='w-60 h-auto flex items-center justify-center relative md:w-24'>
				...
				<Link href="mailto:kwasi.alvarez@hotmail.com" className='flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
				 bg-dark text-light shadow-md border border-solid border-dark w-24 h-24 rounded-full 
